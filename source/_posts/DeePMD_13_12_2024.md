...
Recently, Associate Professor Xu Yang from the School of Science at Shenyang Aerospace University, in cooperation with Professor Fei Du and Professor Yi Zeng from Jilin University and other scholars, conducted an in-depth study on the cubic phase $K_{3}SbS_{4}$ solid-state electrolyte based on the DeePMD method. The related research results were published in the journal "Chemistry of Materials" under the title "Cl-Doped Cubic K<sub>3</sub>SbS<sub>4</sub> as a Solid-State Electrolyte for K-Ion Batteries with Ultrafast Ionic Conductivity" (DOI: 10.1021/acs.chemmater.4c02575).
